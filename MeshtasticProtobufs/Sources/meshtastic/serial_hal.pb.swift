...
public struct SerialHalCommand {
...
extension SerialHalCommand.TypeEnum: CaseIterable {
...
public struct SerialHalResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension SerialHalResponse.Result: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
extension SerialHalCommand: @unchecked Sendable {}
extension SerialHalCommand.TypeEnum: @unchecked Sendable {}
extension SerialHalResponse: @unchecked Sendable {}
extension SerialHalResponse.Result: @unchecked Sendable {}
...
extension SerialHalCommand.TypeEnum: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "UNSET"),
    1: .same(proto: "PIN_MODE"),
    2: .same(proto: "DIGITAL_WRITE"),
    3: .same(proto: "DIGITAL_READ"),
    4: .same(proto: "ATTACH_INTERRUPT"),
    5: .same(proto: "DETACH_INTERRUPT"),
    6: .same(proto: "SPI_TRANSFER"),
    7: .same(proto: "NOOP"),
  ]
}
