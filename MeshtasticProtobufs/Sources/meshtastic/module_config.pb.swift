...
public struct ModuleConfig {
  ...
  public enum OneOf_PayloadVariant: Equatable {
    ...
    public static func ==(lhs: ModuleConfig.OneOf_PayloadVariant, rhs: ModuleConfig.OneOf_PayloadVariant) -> Bool {
      ...
      case (.statusmessage, .statusmessage): return {
        guard case .statusmessage(let l) = lhs, case .statusmessage(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.trafficManagement, .trafficManagement): return {
        guard case .trafficManagement(let l) = lhs, case .trafficManagement(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.tak, .tak): return {
        guard case .tak(let l) = lhs, case .tak(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
  ...
  public struct TrafficManagementConfig {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
  ...
  public struct StatusMessageConfig {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension ModuleConfig.TrafficManagementConfig: @unchecked Sendable {}
...
extension ModuleConfig.StatusMessageConfig: @unchecked Sendable {}
extension ModuleConfig.TAKConfig: @unchecked Sendable {}
...
extension ModuleConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    14: .same(proto: "statusmessage"),
    15: .standard(proto: "traffic_management"),
    16: .same(proto: "tak"),
  ]
...
extension ModuleConfig.TrafficManagementConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "enabled"),
    2: .standard(proto: "position_dedup_enabled"),
    3: .standard(proto: "position_precision_bits"),
    4: .standard(proto: "position_min_interval_secs"),
    5: .standard(proto: "nodeinfo_direct_response"),
    6: .standard(proto: "nodeinfo_direct_response_max_hops"),
    7: .standard(proto: "rate_limit_enabled"),
    8: .standard(proto: "rate_limit_window_secs"),
    9: .standard(proto: "rate_limit_max_packets"),
    10: .standard(proto: "drop_unknown_enabled"),
    11: .standard(proto: "unknown_packet_threshold"),
    12: .standard(proto: "exhaust_hop_telemetry"),
    13: .standard(proto: "exhaust_hop_position"),
    14: .standard(proto: "router_preserve_hops"),
  ]
...
extension ModuleConfig.TelemetryConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    15: .standard(proto: "air_quality_screen_enabled"),
  ]
