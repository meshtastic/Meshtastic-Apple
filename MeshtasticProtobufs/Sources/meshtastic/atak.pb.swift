...
public enum CotHow: SwiftProtobuf.Enum {
  public typealias RawValue = Int
...
public enum CotType: SwiftProtobuf.Enum {
  public typealias RawValue = Int
...
extension CotType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
public enum GeoPointSource: SwiftProtobuf.Enum {
  public typealias RawValue = Int
...
extension GeoPointSource: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
public struct GeoChat {
  ...
  public enum ReceiptType: SwiftProtobuf.Enum {
    public typealias RawValue = Int
...
extension GeoChat.ReceiptType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
public struct DrawnShape {
  ...
  public enum StyleMode: SwiftProtobuf.Enum {
    public typealias RawValue = Int
...
extension DrawnShape.Kind: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
extension DrawnShape.StyleMode: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
extension Marker.Kind: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
extension Route.Method: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
extension Route.Direction: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
public struct CasevacReport {
  ...
  ///
  /// Line 3: precedence / urgency.
  public enum Precedence: SwiftProtobuf.Enum {
    public typealias RawValue = Int
    case unspecified // = 0
  ...
  ///
  /// Line 7: HLZ marking method.
  public enum HlzMarking: SwiftProtobuf.Enum {
    public typealias RawValue = Int
    case unspecified // = 0
    case panels // = 1
    case pyroSignal // = 2
  ...
  public enum Security: SwiftProtobuf.Enum {
    public typealias RawValue = Int
    case unspecified // = 0
...
extension CasevacReport.Precedence: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
extension CasevacReport.HlzMarking: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
extension CasevacReport.Security: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
extension EmergencyAlert.TypeEnum: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
extension TaskRequest.Priority: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
extension TaskRequest.Status: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
extension SensorFov.SensorType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
public struct TAKPacketV2 {
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: TAKPacketV2.OneOf_PayloadVariant, rhs: TAKPacketV2.OneOf_PayloadVariant) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
      ...
      case (.aircraft, .aircraft): return {
        guard case .aircraft(let l) = lhs, case .aircraft(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.rawDetail, .rawDetail): return {
        guard case .rawDetail(let l) = lhs, case .rawDetail(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      ...
      case (.marker, .marker): return {
        guard case .marker(let l) = lhs, case .marker(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.rab, .rab): return {
        guard case .rab(let l) = lhs, case .rab(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      ...
      case (.casevac, .casevac): return {
        guard case .casevac(let l) = lhs, case .casevac(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      ...
      case (.task, .task): return {
        guard case .task(let l) = lhs, case .task(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      default: return false
      }
...
extension CotHow: @unchecked Sendable {}
extension CotType: @unchecked Sendable {}
extension GeoPointSource: @unchecked Sendable {}
...
extension GeoChat.ReceiptType: @unchecked Sendable {}
...
extension AircraftTrack: @unchecked Sendable {}
extension CotGeoPoint: @unchecked Sendable {}
extension DrawnShape: @unchecked Sendable {}
extension DrawnShape.Kind: @unchecked Sendable {}
extension DrawnShape.StyleMode: @unchecked Sendable {}
extension Marker: @unchecked Sendable {}
extension Marker.Kind: @unchecked Sendable {}
extension RangeAndBearing: @unchecked Sendable {}
extension Route: @unchecked Sendable {}
extension Route.Method: @unchecked Sendable {}
extension Route.Direction: @unchecked Sendable {}
extension Route.Link: @unchecked Sendable {}
extension CasevacReport: @unchecked Sendable {}
extension CasevacReport.Precedence: @unchecked Sendable {}
extension CasevacReport.HlzMarking: @unchecked Sendable {}
extension CasevacReport.Security: @unchecked Sendable {}
extension ZMistEntry: @unchecked Sendable {}
extension EmergencyAlert: @unchecked Sendable {}
extension EmergencyAlert.TypeEnum: @unchecked Sendable {}
extension TaskRequest: @unchecked Sendable {}
extension TaskRequest.Priority: @unchecked Sendable {}
extension TaskRequest.Status: @unchecked Sendable {}
extension TAKEnvironment: @unchecked Sendable {}
extension SensorFov: @unchecked Sendable {}
extension SensorFov.SensorType: @unchecked Sendable {}
extension TAKPacketV2: @unchecked Sendable {}
extension TAKPacketV2.OneOf_PayloadVariant: @unchecked Sendable {}
...
extension CotHow: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "CotHow_Unspecified"),
    1: .same(proto: "CotHow_h_e"),
    2: .same(proto: "CotHow_m_g"),
    3: .same(proto: "CotHow_h_g_i_g_o"),
    4: .same(proto: "CotHow_m_r"),
    5: .same(proto: "CotHow_m_f"),
    6: .same(proto: "CotHow_m_p"),
    7: .same(proto: "CotHow_m_s"),
  ]
}

extension CotType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "CotType_Other"),
    1: .same(proto: "CotType_a_f_G_U_C"),
    2: .same(proto: "CotType_a_f_G_U_C_I"),
    3: .same(proto: "CotType_a_n_A_C_F"),
    4: .same(proto: "CotType_a_n_A_C_H"),
    5: .same(proto: "CotType_a_n_A_C"),
    6: .same(proto: "CotType_a_f_A_M_H"),
    7: .same(proto: "CotType_a_f_A_M"),
    8: .same(proto: "CotType_a_f_A_M_F_F"),
    9: .same(proto: "CotType_a_f_A_M_H_A"),
    10: .same(proto: "CotType_a_f_A_M_H_U_M"),
    11: .same(proto: "CotType_a_h_A_M_F_F"),
    12: .same(proto: "CotType_a_h_A_M_H_A"),
    13: .same(proto: "CotType_a_u_A_C"),
    14: .same(proto: "CotType_t_x_d_d"),
    15: .same(proto: "CotType_a_f_G_E_S_E"),
    16: .same(proto: "CotType_a_f_G_E_V_C"),
    17: .same(proto: "CotType_a_f_S"),
    18: .same(proto: "CotType_a_f_A_M_F"),
    19: .same(proto: "CotType_a_f_A_M_F_C_H"),
    20: .same(proto: "CotType_a_f_A_M_F_U_L"),
    21: .same(proto: "CotType_a_f_A_M_F_L"),
    22: .same(proto: "CotType_a_f_A_M_F_P"),
    23: .same(proto: "CotType_a_f_A_C_H"),
    24: .same(proto: "CotType_a_n_A_M_F_Q"),
    25: .same(proto: "CotType_b_t_f"),
    26: .same(proto: "CotType_b_r_f_h_c"),
    27: .same(proto: "CotType_b_a_o_pan"),
    28: .same(proto: "CotType_b_a_o_opn"),
    29: .same(proto: "CotType_b_a_o_can"),
    30: .same(proto: "CotType_b_a_o_tbl"),
    31: .same(proto: "CotType_b_a_g"),
    32: .same(proto: "CotType_a_f_G"),
    33: .same(proto: "CotType_a_f_G_U"),
    34: .same(proto: "CotType_a_h_G"),
    35: .same(proto: "CotType_a_u_G"),
    36: .same(proto: "CotType_a_n_G"),
    37: .same(proto: "CotType_b_m_r"),
    38: .same(proto: "CotType_b_m_p_w"),
    39: .same(proto: "CotType_b_m_p_s_p_i"),
    40: .same(proto: "CotType_u_d_f"),
    41: .same(proto: "CotType_u_d_r"),
    42: .same(proto: "CotType_u_d_c_c"),
    43: .same(proto: "CotType_u_rb_a"),
    44: .same(proto: "CotType_a_h_A"),
    45: .same(proto: "CotType_a_u_A"),
    46: .same(proto: "CotType_a_f_A_M_H_Q"),
    47: .same(proto: "CotType_a_f_A_C_F"),
    48: .same(proto: "CotType_a_f_A_C"),
    49: .same(proto: "CotType_a_f_A_C_L"),
    50: .same(proto: "CotType_a_f_A"),
    51: .same(proto: "CotType_a_f_A_M_H_C"),
    52: .same(proto: "CotType_a_n_A_M_F_F"),
    53: .same(proto: "CotType_a_u_A_C_F"),
    54: .same(proto: "CotType_a_f_G_U_C_F_T_A"),
    55: .same(proto: "CotType_a_f_G_U_C_V_S"),
    56: .same(proto: "CotType_a_f_G_U_C_R_X"),
    57: .same(proto: "CotType_a_f_G_U_C_I_Z"),
    58: .same(proto: "CotType_a_f_G_U_C_E_C_W"),
    59: .same(proto: "CotType_a_f_G_U_C_I_L"),
    60: .same(proto: "CotType_a_f_G_U_C_R_O"),
    61: .same(proto: "CotType_a_f_G_U_C_R_V"),
    62: .same(proto: "CotType_a_f_G_U_H"),
    63: .same(proto: "CotType_a_f_G_U_U_M_S_E"),
    64: .same(proto: "CotType_a_f_G_U_S_M_C"),
    65: .same(proto: "CotType_a_f_G_E_S"),
    66: .same(proto: "CotType_a_f_G_E"),
    67: .same(proto: "CotType_a_f_G_E_V_C_U"),
    68: .same(proto: "CotType_a_f_G_E_V_C_ps"),
    69: .same(proto: "CotType_a_u_G_E_V"),
    70: .same(proto: "CotType_a_f_S_N_N_R"),
    71: .same(proto: "CotType_a_f_F_B"),
    72: .same(proto: "CotType_b_m_p_s_p_loc"),
    73: .same(proto: "CotType_b_i_v"),
    74: .same(proto: "CotType_b_f_t_r"),
    75: .same(proto: "CotType_b_f_t_a"),
    76: .same(proto: "CotType_u_d_f_m"),
    77: .same(proto: "CotType_u_d_p"),
    78: .same(proto: "CotType_b_m_p_s_m"),
    79: .same(proto: "CotType_b_m_p_c"),
    80: .same(proto: "CotType_u_r_b_c_c"),
    81: .same(proto: "CotType_u_r_b_bullseye"),
    82: .same(proto: "CotType_a_f_G_E_V_A"),
    83: .same(proto: "CotType_a_n_A"),
    84: .same(proto: "CotType_a_u_G_U_C_F"),
    85: .same(proto: "CotType_a_n_G_U_C_F"),
    86: .same(proto: "CotType_a_h_G_U_C_F"),
    87: .same(proto: "CotType_a_f_G_U_C_F"),
    88: .same(proto: "CotType_a_u_G_I"),
    89: .same(proto: "CotType_a_n_G_I"),
    90: .same(proto: "CotType_a_h_G_I"),
    91: .same(proto: "CotType_a_f_G_I"),
    92: .same(proto: "CotType_a_u_G_E_X_M"),
    93: .same(proto: "CotType_a_n_G_E_X_M"),
    94: .same(proto: "CotType_a_h_G_E_X_M"),
    95: .same(proto: "CotType_a_f_G_E_X_M"),
    96: .same(proto: "CotType_a_u_S"),
    97: .same(proto: "CotType_a_n_S"),
    98: .same(proto: "CotType_a_h_S"),
    99: .same(proto: "CotType_a_u_G_U_C_I_d"),
    100: .same(proto: "CotType_a_n_G_U_C_I_d"),
    101: .same(proto: "CotType_a_h_G_U_C_I_d"),
    102: .same(proto: "CotType_a_f_G_U_C_I_d"),
    103: .same(proto: "CotType_a_u_G_E_V_A_T"),
    104: .same(proto: "CotType_a_n_G_E_V_A_T"),
    105: .same(proto: "CotType_a_h_G_E_V_A_T"),
    106: .same(proto: "CotType_a_f_G_E_V_A_T"),
    107: .same(proto: "CotType_a_u_G_U_C_I"),
    108: .same(proto: "CotType_a_n_G_U_C_I"),
    109: .same(proto: "CotType_a_h_G_U_C_I"),
    110: .same(proto: "CotType_a_n_G_E_V"),
    111: .same(proto: "CotType_a_h_G_E_V"),
    112: .same(proto: "CotType_a_f_G_E_V"),
    113: .same(proto: "CotType_b_m_p_w_GOTO"),
    114: .same(proto: "CotType_b_m_p_c_ip"),
    115: .same(proto: "CotType_b_m_p_c_cp"),
    116: .same(proto: "CotType_b_m_p_s_p_op"),
    117: .same(proto: "CotType_u_d_v"),
    118: .same(proto: "CotType_u_d_v_m"),
    119: .same(proto: "CotType_u_d_c_e"),
    120: .same(proto: "CotType_b_i_x_i"),
    121: .same(proto: "CotType_b_t_f_d"),
    122: .same(proto: "CotType_b_t_f_r"),
    123: .same(proto: "CotType_b_a_o_c"),
    124: .same(proto: "CotType_t_s"),
  ]
}

extension GeoPointSource: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "GeoPointSource_Unspecified"),
    1: .same(proto: "GeoPointSource_GPS"),
    2: .same(proto: "GeoPointSource_USER"),
    3: .same(proto: "GeoPointSource_NETWORK"),
  ]
}
...
extension GeoChat: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    4: .standard(proto: "receipt_for_uid"),
    5: .standard(proto: "receipt_type"),
  ]
...
extension GeoChat.ReceiptType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "ReceiptType_None"),
    1: .same(proto: "ReceiptType_Delivered"),
    2: .same(proto: "ReceiptType_Read"),
  ]
}
...
extension AircraftTrack: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    3: .same(proto: "flight"),
    4: .standard(proto: "aircraft_type"),
    5: .same(proto: "squawk"),
    6: .same(proto: "category"),
    7: .standard(proto: "rssi_x10"),
    8: .same(proto: "gps"),
    9: .standard(proto: "cot_host_id"),
  ]
...
extension CotGeoPoint: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "lat_delta_i"),
    2: .standard(proto: "lon_delta_i"),
  ]
...
extension DrawnShape: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "kind"),
    2: .same(proto: "style"),
    3: .standard(proto: "major_cm"),
    4: .standard(proto: "minor_cm"),
    5: .standard(proto: "angle_deg"),
    6: .standard(proto: "stroke_color"),
    7: .standard(proto: "stroke_argb"),
    8: .standard(proto: "stroke_weight_x10"),
    9: .standard(proto: "fill_color"),
    10: .standard(proto: "fill_argb"),
    11: .standard(proto: "labels_on"),
    12: .same(proto: "vertices"),
    13: .same(proto: "truncated"),
    14: .standard(proto: "bullseye_distance_dm"),
    15: .standard(proto: "bullseye_bearing_ref"),
    16: .standard(proto: "bullseye_flags"),
    17: .standard(proto: "bullseye_uid_ref"),
  ]
...
extension DrawnShape.Kind: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    1: .same(proto: "Kind_Circle"),
    2: .same(proto: "Kind_Rectangle"),
    3: .same(proto: "Kind_Freeform"),
    4: .same(proto: "Kind_Telestration"),
    5: .same(proto: "Kind_Polygon"),
    6: .same(proto: "Kind_RangingCircle"),
    7: .same(proto: "Kind_Bullseye"),
    8: .same(proto: "Kind_Ellipse"),
    9: .same(proto: "Kind_Vehicle2D"),
    10: .same(proto: "Kind_Vehicle3D"),
  ]
}

extension DrawnShape.StyleMode: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "StyleMode_Unspecified"),
    1: .same(proto: "StyleMode_StrokeOnly"),
    2: .same(proto: "StyleMode_FillOnly"),
    3: .same(proto: "StyleMode_StrokeAndFill"),
  ]
}
...
extension Marker: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "kind"),
    2: .same(proto: "color"),
    3: .standard(proto: "color_argb"),
    4: .same(proto: "readiness"),
    5: .standard(proto: "parent_uid"),
    6: .standard(proto: "parent_type"),
    7: .standard(proto: "parent_callsign"),
    8: .same(proto: "iconset"),
  ]
...
extension Marker.Kind: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "Kind_Unspecified"),
    1: .same(proto: "Kind_Spot"),
    2: .same(proto: "Kind_Waypoint"),
    3: .same(proto: "Kind_Checkpoint"),
    4: .same(proto: "Kind_SelfPosition"),
    5: .same(proto: "Kind_Symbol2525"),
    6: .same(proto: "Kind_SpotMap"),
    7: .same(proto: "Kind_CustomIcon"),
    8: .same(proto: "Kind_GoToPoint"),
    9: .same(proto: "Kind_InitialPoint"),
    10: .same(proto: "Kind_ContactPoint"),
    11: .same(proto: "Kind_ObservationPost"),
    12: .same(proto: "Kind_ImageMarker"),
  ]
}
...
extension RangeAndBearing: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "anchor"),
    2: .standard(proto: "anchor_uid"),
    3: .standard(proto: "range_cm"),
    4: .standard(proto: "bearing_cdeg"),
    5: .standard(proto: "stroke_color"),
    6: .standard(proto: "stroke_argb"),
    7: .standard(proto: "stroke_weight_x10"),
  ]
...
extension Route: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    3: .same(proto: "prefix"),
    4: .standard(proto: "stroke_weight_x10"),
    5: .same(proto: "links"),
    6: .same(proto: "truncated"),
  ]
...
extension Route.Method: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    1: .same(proto: "Method_Driving"),
    2: .same(proto: "Method_Walking"),
    3: .same(proto: "Method_Flying"),
    4: .same(proto: "Method_Swimming"),
    5: .same(proto: "Method_Watercraft"),
  ]
}
...
extension Route.Direction: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    1: .same(proto: "Direction_Infil"),
    2: .same(proto: "Direction_Exfil"),
  ]
}
...
extension CasevacReport: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    2: .standard(proto: "equipment_flags"),
    3: .standard(proto: "litter_patients"),
    4: .standard(proto: "ambulatory_patients"),
    5: .same(proto: "security"),
    6: .standard(proto: "hlz_marking"),
    7: .standard(proto: "zone_marker"),
    8: .standard(proto: "us_military"),
    9: .standard(proto: "us_civilian"),
    10: .standard(proto: "non_us_military"),
    11: .standard(proto: "non_us_civilian"),
    12: .same(proto: "epw"),
    13: .same(proto: "child"),
    14: .standard(proto: "terrain_flags"),
    15: .same(proto: "frequency"),
    16: .same(proto: "title"),
    17: .standard(proto: "medline_remarks"),
    18: .standard(proto: "urgent_count"),
    19: .standard(proto: "urgent_surgical_count"),
    20: .standard(proto: "priority_count"),
    21: .standard(proto: "routine_count"),
    22: .standard(proto: "convenience_count"),
    23: .standard(proto: "equipment_detail"),
    24: .standard(proto: "zone_protected_coord"),
    25: .standard(proto: "terrain_slope_dir"),
    26: .standard(proto: "terrain_other_detail"),
    27: .standard(proto: "marked_by"),
    28: .same(proto: "obstacles"),
    29: .standard(proto: "winds_are_from"),
    30: .same(proto: "friendlies"),
    31: .same(proto: "enemy"),
    32: .standard(proto: "hlz_remarks"),
    33: .same(proto: "zmist"),
  ]
...
extension CasevacReport.Precedence: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "Precedence_Unspecified"),
    1: .same(proto: "Precedence_Urgent"),
    2: .same(proto: "Precedence_UrgentSurgical"),
    3: .same(proto: "Precedence_Priority"),
    4: .same(proto: "Precedence_Routine"),
    5: .same(proto: "Precedence_Convenience"),
  ]
}

extension CasevacReport.HlzMarking: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "HlzMarking_Unspecified"),
    1: .same(proto: "HlzMarking_Panels"),
    2: .same(proto: "HlzMarking_PyroSignal"),
    3: .same(proto: "HlzMarking_Smoke"),
    4: .same(proto: "HlzMarking_None"),
    5: .same(proto: "HlzMarking_Other"),
  ]
}

extension CasevacReport.Security: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "Security_Unspecified"),
    1: .same(proto: "Security_NoEnemy"),
    2: .same(proto: "Security_PossibleEnemy"),
    3: .same(proto: "Security_EnemyInArea"),
    4: .same(proto: "Security_EnemyInArmedContact"),
  ]
}
...
extension EmergencyAlert: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "type"),
    2: .standard(proto: "authoring_uid"),
    3: .standard(proto: "cancel_reference_uid"),
  ]
...
extension EmergencyAlert.TypeEnum: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    1: .same(proto: "Type_Alert911"),
    2: .same(proto: "Type_RingTheBell"),
    3: .same(proto: "Type_InContact"),
    4: .same(proto: "Type_GeoFenceBreached"),
    5: .same(proto: "Type_Custom"),
    6: .same(proto: "Type_Cancel"),
  ]
}
...
extension TaskRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    2: .standard(proto: "target_uid"),
    3: .standard(proto: "assignee_uid"),
...
extension TaskRequest.Priority: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    2: .same(proto: "Priority_Normal"),
    3: .same(proto: "Priority_High"),
    4: .same(proto: "Priority_Critical"),
  ]
}
...
extension TaskRequest.Status: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    2: .same(proto: "Status_Acknowledged"),
    3: .same(proto: "Status_InProgress"),
    4: .same(proto: "Status_Completed"),
...
extension TAKEnvironment: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "temperature_c_x10"),
    2: .standard(proto: "wind_direction_deg"),
    3: .standard(proto: "wind_speed_cm_s"),
  ]
...
extension SensorFov: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "type"),
    2: .standard(proto: "azimuth_deg"),
    3: .standard(proto: "range_m"),
    4: .standard(proto: "fov_horizontal_deg"),
    5: .standard(proto: "fov_vertical_deg"),
    6: .standard(proto: "elevation_deg"),
    7: .standard(proto: "roll_deg"),
    8: .same(proto: "model"),
  ]
...
extension SensorFov.SensorType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "SensorType_Unspecified"),
    1: .same(proto: "SensorType_Camera"),
    2: .same(proto: "SensorType_Thermal"),
    3: .same(proto: "SensorType_Laser"),
    4: .same(proto: "SensorType_Nvg"),
    5: .same(proto: "SensorType_Rf"),
    6: .same(proto: "SensorType_Other"),
  ]
}
...
extension TAKPacketV2: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "cot_type_id"),
    2: .same(proto: "how"),
    3: .same(proto: "callsign"),
    4: .same(proto: "team"),
    5: .same(proto: "role"),
    6: .standard(proto: "latitude_i"),
    7: .standard(proto: "longitude_i"),
    8: .same(proto: "altitude"),
    9: .same(proto: "speed"),
    10: .same(proto: "course"),
    11: .same(proto: "battery"),
    12: .standard(proto: "geo_src"),
    13: .standard(proto: "alt_src"),
    14: .same(proto: "uid"),
    15: .standard(proto: "device_callsign"),
    16: .standard(proto: "stale_seconds"),
    17: .standard(proto: "tak_version"),
    18: .standard(proto: "tak_device"),
    19: .standard(proto: "tak_platform"),
    20: .standard(proto: "tak_os"),
    21: .same(proto: "endpoint"),
    22: .same(proto: "phone"),
    23: .standard(proto: "cot_type_str"),
    24: .same(proto: "remarks"),
    25: .same(proto: "environment"),
    26: .standard(proto: "sensor_fov"),
    30: .same(proto: "pli"),
    31: .same(proto: "chat"),
    32: .same(proto: "aircraft"),
    33: .standard(proto: "raw_detail"),
    34: .same(proto: "shape"),
    35: .same(proto: "marker"),
    36: .same(proto: "rab"),
    37: .same(proto: "route"),
    38: .same(proto: "casevac"),
    39: .same(proto: "emergency"),
    40: .same(proto: "task"),
  ]
