...
public enum FirmwareEdition: SwiftProtobuf.Enum {
  public typealias RawValue = Int
...
extension FirmwareEdition: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
public struct StoreForwardPlusPlus {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public enum SFPP_message_type: SwiftProtobuf.Enum {
    public typealias RawValue = Int
...
extension StoreForwardPlusPlus.SFPP_message_type: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
extension RemoteShell.OpCode: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
public struct MeshPacket {
  ...
  public enum TransportMechanism: SwiftProtobuf.Enum {
    public typealias RawValue = Int
...
extension MeshPacket.TransportMechanism: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
public struct FromRadio {
  ...
  public enum OneOf_PayloadVariant: Equatable {
    ...
    public static func ==(lhs: FromRadio.OneOf_PayloadVariant, rhs: FromRadio.OneOf_PayloadVariant) -> Bool {
      ...
      case (.lockdownStatus, .lockdownStatus): return {
        guard case .lockdownStatus(let l) = lhs, case .lockdownStatus(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      default: return false
      }
...
extension LockdownStatus.State: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
public struct ClientNotification {
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: ClientNotification.OneOf_PayloadVariant, rhs: ClientNotification.OneOf_PayloadVariant) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
      case (.keyVerificationNumberInform, .keyVerificationNumberInform): return {
        guard case .keyVerificationNumberInform(let l) = lhs, case .keyVerificationNumberInform(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.keyVerificationNumberRequest, .keyVerificationNumberRequest): return {
        guard case .keyVerificationNumberRequest(let l) = lhs, case .keyVerificationNumberRequest(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.keyVerificationFinal, .keyVerificationFinal): return {
        guard case .keyVerificationFinal(let l) = lhs, case .keyVerificationFinal(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.duplicatedPublicKey, .duplicatedPublicKey): return {
        guard case .duplicatedPublicKey(let l) = lhs, case .duplicatedPublicKey(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.lowEntropyKey, .lowEntropyKey): return {
        guard case .lowEntropyKey(let l) = lhs, case .lowEntropyKey(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      default: return false
      }
...
public struct KeyVerificationFinal {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct DuplicatedPublicKey {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension FirmwareEdition: @unchecked Sendable {}
...
extension KeyVerification: @unchecked Sendable {}
extension StoreForwardPlusPlus: @unchecked Sendable {}
extension StoreForwardPlusPlus.SFPP_message_type: @unchecked Sendable {}
extension RemoteShell: @unchecked Sendable {}
extension RemoteShell.OpCode: @unchecked Sendable {}
extension Waypoint: @unchecked Sendable {}
extension StatusMessage: @unchecked Sendable {}
...
extension MeshPacket.TransportMechanism: @unchecked Sendable {}
...
extension LockdownStatus: @unchecked Sendable {}
extension LockdownStatus.State: @unchecked Sendable {}
extension ClientNotification: @unchecked Sendable {}
extension ClientNotification.OneOf_PayloadVariant: @unchecked Sendable {}
extension KeyVerificationNumberInform: @unchecked Sendable {}
extension KeyVerificationNumberRequest: @unchecked Sendable {}
extension KeyVerificationFinal: @unchecked Sendable {}
extension DuplicatedPublicKey: @unchecked Sendable {}
extension LowEntropyKey: @unchecked Sendable {}
...
extension HardwareModel: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    121: .same(proto: "MESHSTICK_1262"),
    122: .same(proto: "TBEAM_1_WATT"),
    123: .same(proto: "T5_S3_EPAPER_PRO"),
    124: .same(proto: "TBEAM_BPF"),
    125: .same(proto: "MINI_EPAPER_S3"),
    126: .same(proto: "TDISPLAY_S3_PRO"),
    127: .same(proto: "HELTEC_MESH_NODE_T096"),
    128: .same(proto: "TRACKER_T1000_E_PRO"),
    129: .same(proto: "THINKNODE_M7"),
    130: .same(proto: "THINKNODE_M8"),
    131: .same(proto: "THINKNODE_M9"),
    132: .same(proto: "HELTEC_V4_R8"),
    133: .same(proto: "HELTEC_MESH_NODE_T1"),
    134: .same(proto: "STATION_G3"),
...
extension Routing.Error: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    39: .same(proto: "PKI_SEND_FAIL_PUBLIC_KEY"),
  ]
}
...
extension RemoteShell: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    3: .same(proto: "seq"),
    4: .standard(proto: "ack_seq"),
    5: .same(proto: "payload"),
    6: .same(proto: "cols"),
    7: .same(proto: "rows"),
    8: .same(proto: "flags"),
    9: .standard(proto: "last_tx_seq"),
    10: .standard(proto: "last_rx_seq"),
  ]
...
extension RemoteShell.OpCode: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    5: .same(proto: "PING"),
    6: .same(proto: "ACK"),
    64: .same(proto: "OPEN_OK"),
    65: .same(proto: "OUTPUT"),
    66: .same(proto: "CLOSED"),
    67: .same(proto: "ERROR"),
    68: .same(proto: "PONG"),
  ]
}
...
extension FromRadio: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    18: .standard(proto: "lockdown_status"),
  ]
...
extension LockdownStatus: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "state"),
    2: .standard(proto: "lock_reason"),
    3: .standard(proto: "boots_remaining"),
    4: .standard(proto: "valid_until_epoch"),
    5: .standard(proto: "backoff_seconds"),
  ]
...
extension LockdownStatus.State: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    1: .same(proto: "NEEDS_PROVISION"),
    2: .same(proto: "LOCKED"),
    3: .same(proto: "UNLOCKED"),
    4: .same(proto: "UNLOCK_FAILED"),
  ]
}
