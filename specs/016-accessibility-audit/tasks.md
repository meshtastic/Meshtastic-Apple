...
**Progress**: T001–T040, T042–T043 done; T041 intentionally deferred as not urgent (see checkboxes below for exact status; parallel branches merged separately, so per-cluster fractions aren't tracked here) — last updated 2026-07-23.
