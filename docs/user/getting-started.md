...
The first time you open the app, a short guided setup walks you through the permissions Meshtastic uses, in order:
...
5. **Siri** — optional; enables voice commands for sending messages.

Each screen explains what the permission is for, and you can change any of these later in iOS Settings. Granting a permission or tapping **Continue** advances to the next step.
