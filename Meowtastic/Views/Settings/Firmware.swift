	...
	var body: some View {
		...
		ScrollView {
			VStack(alignment: .leading) {
				...
				if currentDevice?.architecture == Meowtastic.Architecture.nrf52840 {
					VStack(alignment: .leading) {
				...
				} else if currentDevice?.architecture == Meowtastic.Architecture.esp32 || currentDevice?.architecture == Meowtastic.Architecture.esp32S3 || currentDevice?.architecture == Meowtastic.Architecture.esp32C3 {
					VStack(alignment: .leading) {
