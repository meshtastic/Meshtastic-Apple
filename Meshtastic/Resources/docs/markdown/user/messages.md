...
- The shield appears only on broadcast/channel messages, never on direct messages, and only when verification succeeded. Long-press a signed message and open **Message Details** to see "Signed · verified — Verified with the sender's key."
