...
**Jun 2026** — [MQTT](mqtt.md) — MQTT client proxy improvements: per-channel downlink subscriptions (matching Android), zero-hop injection to prevent RF re-broadcast, password masking, and removal of the deprecated JSON mode toggle.
