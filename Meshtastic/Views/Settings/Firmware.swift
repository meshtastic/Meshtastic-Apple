		...
		ScrollView {
			VStack(alignment: .leading) {
				...
				Text("Get the latest stable firmware")
					.fixedSize(horizontal: false, vertical: true)
					.font(.callout)
				Link("\(latestStable?.title ?? NSLocalizedString("unknown", comment: "No comment provided"))", destination: URL(string: "\(latestStable?.zipURL ?? "https://meshtastic.org")")!)
					.font(.caption)
				...
				Text("Get the latest alpha firmware")
					.fixedSize(horizontal: false, vertical: true)
					.font(.callout)
				Link("\(latestAlpha?.title ?? NSLocalizedString("unknown", comment: "No comment provided"))", destination: URL(string: "\(latestAlpha?.zipURL ?? "https://meshtastic.org")")!)
					.font(.caption)
