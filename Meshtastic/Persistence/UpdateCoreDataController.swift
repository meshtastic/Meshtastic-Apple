...
public class UpdateCoreDataController: ObservableObject {
	...
	public func clearPax(destNum: Int64) -> Bool {
	...
	func upsertNodeInfoPacket (packet: MeshPacket) {
	...
	func upsertBluetoothConfigPacket(config: Config.BluetoothConfig, nodeNum: Int64) {
	...
	func upsertDeviceConfigPacket(config: Config.DeviceConfig, nodeNum: Int64) {
	...
	func upsertDisplayConfigPacket(config: Config.DisplayConfig, nodeNum: Int64) {
	...
	func upsertLoRaConfigPacket(config: Config.LoRaConfig, nodeNum: Int64) {
	...
	func upsertNetworkConfigPacket(config: Config.NetworkConfig, nodeNum: Int64) {
	...
	func upsertPositionConfigPacket(config: Config.PositionConfig, nodeNum: Int64) {
	...
	func upsertPowerConfigPacket(config: Config.PowerConfig, nodeNum: Int64) {
	...
	func upsertAmbientLightingModuleConfigPacket(config: ModuleConfig.AmbientLightingConfig, nodeNum: Int64) {
	...
	func upsertCannedMessagesModuleConfigPacket(config: ModuleConfig.CannedMessageConfig, nodeNum: Int64) {
	...
	func upsertDetectionSensorModuleConfigPacket(config: ModuleConfig.DetectionSensorConfig, nodeNum: Int64) {
	...
	func upsertExternalNotificationModuleConfigPacket(config: ModuleConfig.ExternalNotificationConfig, nodeNum: Int64) {
	...
	func upsertPaxCounterModuleConfigPacket(config: ModuleConfig.PaxcounterConfig, nodeNum: Int64) {
	...
	func upsertRtttlConfigPacket(ringtone: String, nodeNum: Int64) {
	...
	func upsertMqttModuleConfigPacket(config: ModuleConfig.MQTTConfig, nodeNum: Int64) {
	...
	func upsertRangeTestModuleConfigPacket(config: ModuleConfig.RangeTestConfig, nodeNum: Int64) {
	...
	func upsertSerialModuleConfigPacket(config: ModuleConfig.SerialConfig, nodeNum: Int64) {
	...
	func upsertStoreForwardModuleConfigPacket(config: ModuleConfig.StoreForwardConfig, nodeNum: Int64) {
	...
	func upsertTelemetryModuleConfigPacket(config: ModuleConfig.TelemetryConfig, nodeNum: Int64) {
