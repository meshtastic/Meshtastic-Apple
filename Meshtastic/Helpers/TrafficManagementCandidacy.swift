...
enum TrafficManagementCandidacy {
	...
	static func summary(directNeighborCount count: Int) -> String {
		...
		case .limited:
			return String(localized: "This node heard \(count) nodes directly in the last two hours. Traffic management is built for well-placed nodes with 50 or more direct neighbors; it will have little effect here.")
		}
	}
}
